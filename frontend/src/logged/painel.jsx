...
export const Painel = () => {
    ...
    const search = async ()=>{
        ...
        fetch(`${BACKEND_URL}/cnpj_data`,{
          ...
          .catch((error)=>{console.log(error);setLoading(false); alert('Nenhum dado encontrado para os filtros selecionados, caso o problema persistir, refaça o login e tente novamente!')})
    }
